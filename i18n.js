...
(function () {
  ...
  const dict = {
    nl: {
      ...
      "hero.subtitle":
        "Agents, MCP-integraties en AI-platformen die zelfstandig werk uitvoeren in bestaande bedrijfsprocessen.",
    ...
    en: {
      ...
      "hero.role": "AI Tech Lead · Agentic systems",
      "hero.subtitle":
        "Agents, MCP integrations and AI platforms that execute work autonomously inside existing business processes.",
